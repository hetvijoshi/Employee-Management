namespace EmployeeClient.Leave
{
	partial class EmployeeLeave
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Request Leave";
			...
			this.button2.Text = "Check Leave Status";
			this.button2.UseVisualStyleBackColor = true;
			this.button2.Click += new System.EventHandler(this.button2_Click_1);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(128, 316);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(153, 42);
			this.button4.TabIndex = 4;
			this.button4.Text = "Cancel Leave";
